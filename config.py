...
youtube_dl_link = 'youtube-dl -f \'bestvideo[height<=480]+bestaudio/best[height<=480]\' --write-description --write-info-json --download-archive downloaded_{}.txt --no-post-overwrites --restrict-filenames -ciw -o "{}%(upload_date)s_%(title)s_%()s_%(display_id)s.%(ext)s" -v {}'
